...
import {
  ...
  CommercialDistributorListResponse,
  ReportFilters,
  ReportListResponse,
  UsersFilters,
} from "@/types/types";
...
const url_base =
  process.env.NEXT_PUBLIC_SERVER_ECO_URL ?? "http://localhost:8000";
...
// Users section
export const fetchUsers = new ApiFetch<
  CampaignListResponse,
  HTTPRequestError<string[]>,
  UsersFilters
>({
...
export const userFilters = new AtomFilters<UsersFilters>({
  page: 0,
  page_size: 20,
});

export const usersDataTableAtom = new AtomsDataTable({
  pagination: {
    pageIndex: 0,
    pageSize: 20,
  },
...
// Users section
export const fetchReport = new ApiFetch<
  ReportListResponse,
  HTTPRequestError<string[]>,
  ReportFilters
>({
...
export const reportFilters = new AtomFilters<ReportFilters>({
  page: 0,
  page_size: 20,
});

export const ReportDataTableAtom = new AtomsDataTable({
  pagination: {
    pageIndex: 0,
    pageSize: 20,
  },
